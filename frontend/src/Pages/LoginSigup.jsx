  ...
  return (
    ...
    <div className='loginsignup'>
      <div className="loginsigup-container">
        ...
        {state === "Sign Up" ? <p className="loginsigup-login">Already have an account?
          <span onClick={() => setState("Login")}>Login here</span></p>

          : <p className="loginsigup-login">Create an account?
            <span onClick={() => setState("Sign Up")}>Click here</span></p>}


        <div className='loginsigup-agree'>
          <input type="checkbox" name="" id="" className='big-checkbox' />
